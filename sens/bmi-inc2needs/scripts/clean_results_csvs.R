...
data_root = ".../projects/abcd-projs/smri-pub-abcd/sens/bmi-inc2needs/results/"

files <- list.files(data_root, pattern = "\\_combat.csv$", full.names = TRUE)
#files <- paste0(data_root, "all_results_smri_area_cdk_banksstsrh_f.csv")
...
write.csv(model_fit_combined_df, file = paste0(proj_root, "sens/bmi-inc2needs/results/cleaned/combat_combined_model_fit_results.csv"), row.names = FALSE)
...
write.csv(best_fit_df, file = paste0(proj_root, "sens/bmi-inc2needs/results/cleaned/combat_best_fits.csv"), row.names = FALSE)
...
write.csv(pvals_combined_df, file = paste0(proj_root, "sens/bmi-inc2needs/results/cleaned/combat_combined_pvals.csv"), row.names = FALSE)
